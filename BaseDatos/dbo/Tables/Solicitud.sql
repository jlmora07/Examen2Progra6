...
IdCliente INT NOT NULL CONSTRAINT [FK_Solicitud_Cliente] FOREIGN KEY (IdCliente)
REFERENCES dbo.Cliente (IdCliente),
 IdServicio INT NOT NULL CONSTRAINT [FK_Solicitud_Servicio] FOREIGN KEY (IdServicio) REFERENCES
